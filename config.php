<?php
    ...
    $config = [
        "products" => [
            [
                "id" => "9655500b-5de4-4b21-a83e-15a69e68142e",
                "name" => "Ragnar Goossens",
                "image" => "./assets/img/bank1.jpg",
                "litImg" => "./assets/img/roze1.jpg",
                "litImg2" => "./assets/img/roze2.jpg",
            ...
            [
                ...
                "name" => "Lounge Trentino",
                "image" => "./assets/img/bank8.jpg",
            ...
            [
                ...
                "name" => "Zits Key West",
                "image" => "./assets/img/bank9.jpg",
                "originalPrice" => "€ 2.999,00",
                "discountedPrice" => "€ 2.799,00",
                "text"=> "Breng de warme en uitnodigende sfeer van het Caribisch gebied naar je woonkamer met de Zits Key West. Met zijn rijke bruine kleur en comfortabele ontwerp straalt deze bank gezelligheid en ontspanning uit. Perfect voor het creëren van een knusse zithoek in je huis, biedt de Zits Key West een ideale plek om te ontspannen na een lange dag. Ervaar het comfort en de charme van de Zits Key West en laat je interieur stralen met zijn tijdloze elegantie."
            ],
        ]
    ];
?>
