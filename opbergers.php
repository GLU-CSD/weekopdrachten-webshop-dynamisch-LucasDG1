...
?>
    <nav>
      <div class="topbarGrid">
        <div class="nameArticle">Opbergers</div>
    ...
    <div class="article">
      <div class="shopBox">
        ...
        <div class="prijs1">€ 2000,00</div>
        <div class="prijs2">€ 1.895,00</div>
      ...
      <div class="shopBox">
        ...
        <div class="textShop"><a href="https://www.woonexpress.nl/0076590037--000/kledingkast-baarlo-wit.html">Baarlo
            wit</a></div>
        <div class="prijs1">€ 229,00</div>
        <div class="prijs2">€ 206,10</div>
        <button class="btn"><i class="fa fa-heart" aria-hidden="true" style="color: rgb(0, 140, 255);"></i></button>
      </div>
      ...
      <div class="shopBox">
        ...
        <div class="prijs1">€ 1649,00</div>
        <div class="prijs2">€ 1202,99</div>
        <button class="btn"><i class="fa fa-heart" aria-hidden="true" style="color: rgb(0, 140, 255);"></i></button>
      </div>
      ...
      <div class="shopBox">
        ...
        <div class="textShop"><a
            ...
            Kast</a></div>
        <div class="prijs1">€ 1769,00</div>
        <div class="prijs2">€ 1369,00</div>
        <button class="btn"><i class="fa fa-heart" aria-hidden="true" style="color: rgb(0, 140, 255);"></i></button>
      </div>
      ...
      <div class="shopBox">
        ...
        <div class="textShop"><a href="https://www.eltink-interieur.nl/vermeer-wandkast-puur-egk092-4.html">Elthink
            Black</a></div>
        <div class="prijs1">€ 4.249,00</div>
        <div class="prijs2">€ 3.749,00</div>
        <button class="btn"><i class="fa fa-heart" aria-hidden="true" style="color: rgb(0, 140, 255);"></i></button>
      </div>
      ...
      <div class="shopBox">
        ...
        <div class="prijs1">€ 583,00</div>
        <div class="prijs2">€ 525,00</div>
      ...
      <div class="shopBox">
        ...
        <div class="prijs1">€ 949,99</div>
        <div class="prijs2">€ 845,00</div>
        <button class="btn"><i class="fa fa-heart" aria-hidden="true" style="color: rgb(0, 140, 255);"></i></button>
      </div>
      ...
      <div class="shopBox">
        ...
        <div class="textShop"><a
            ...
            boekenkast</a></div>
        <div class="prijs1">€ 5.899,99</div>
        <div class="prijs2">€ 5.250,00</div>
        <button class="btn"><i class="fa fa-heart" aria-hidden="true" style="color: rgb(0, 140, 255);"></i></button>
      </div>
